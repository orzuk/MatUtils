...
% $Revision: 1.1.6.10 $  $Date: 2008/06/24 17:11:45 $
...
%imgWidth = 350;
imgWidth = fullWidth; % My change (TS)
...
%          top = margin + 10*imgCount;
        left = (slideWidth-imgWidth-margin); % My change (TS)
        top = margin; % My change (TS)
         ...
         delete([tempdir img]);
         imgCount = imgCount + 1;
         slide = addSlide(openPresentation,presentationSlides); % My change (TS)
