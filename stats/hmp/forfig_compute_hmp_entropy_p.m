% Generate HMP entropy plots for paper's fig for p constant
...
p_vec = [0.1]; % Set the epsilon we want to work with
...
%         N
    ...
    subplot(2,1,2); hold on; plot(eps_vec, ent_orders_est_vec, 'r'); %plot([0:101], log(abs([Hp_zero Hp(1:101)'])), '+');  
