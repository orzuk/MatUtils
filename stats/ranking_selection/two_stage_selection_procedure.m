% Apply DalalDudevich or Rinott's procedure
%
% Input:
...
%
function [max_I, PCS_res, h] = two_stage_selection_procedure(N0, PCS, Delta, mu_vec, sigma_vec, iters, method_str)

n_pop = length(mu_vec);

q_p = (-1/log(PCS))^(1/(N0-1)); % gevinv(PCS, 0, N0-1, 0); % what should we take here? how many deg. freedom? what is v-Frechet? 
