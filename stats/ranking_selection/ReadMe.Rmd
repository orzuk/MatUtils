...
The script saves tables available in the [data](data) directory: 
[data/N_star_numerics.txt](data/N_star_numerics.txt) shows values appearing in Figure 1 in the paper. 
