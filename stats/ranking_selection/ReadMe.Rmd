...
[1] [On The Asymptotic Efficiency of Selection Procedures for Independent Gaussian Populations](https://arxiv.org/abs/1707.00314) <br />
R. Jacobovic and O. Zuk. Submitted (2017) 
...
The script saves tables available in the [data] directory: 
[data/N_star_numerics.txt] shows values appearing in Figure 1 in the paper. 
[data/h1_h2_numerics.txt] shows values appearing in Figure 2 in the paper. 
