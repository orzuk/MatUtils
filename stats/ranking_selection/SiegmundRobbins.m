...
relative_error_mat_save = [ [{'Relative error as function of k and p'} cell(1, 4)]'  [{'k \ p'} num2str_cell(num2cell(pcs_vec))]'  [num2cell(k_vec') num2str_cell(num2cell(relative_error_mat), '%2.3f')]' ]';
