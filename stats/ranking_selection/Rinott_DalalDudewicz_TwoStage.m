...
relative_error_matrix_save = [ [{'Table 2: Relative error for h_k for two procedures, as function of k and p'} cell(1, 4)]' ...
     [{'p'} num2str_cell(num2cell(pcs_vec([1 1 2 2])))]' [{'Proc.', '1', '2', '1', '2'} ]'  [{'k'} cell(1,4)]' [num2cell(k_vec') num2str_cell(num2cell(rel_error_vec), '%2.3f')]' ]';
