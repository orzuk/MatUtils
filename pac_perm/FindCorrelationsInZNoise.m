% Here we check the noise of Z over a finite sample for different genes,
% to see if these noises are correlated !
...
function [N_VEC Pearson_corrs Fisher_Zs Rho_sig_mean Rho_sig_std Rho_bias_mean Rho_bias_std ...
    ...
    = FindCorrelationsInZNoise(R, Fisher_Zs, rand_flag, iters ) % We input here the correct Fisher Z's !
