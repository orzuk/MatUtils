...
demography_str = 'two-stage-expan'; % 'expansion1'; % 'two-stage-expan'; % 'expansion1'; % choose demographic model
...
N_vec = []; [N_vec{1}, D] = create_demographic_model(demography_str, 1); N = N_vec{1}(1); % 'expansion1');
