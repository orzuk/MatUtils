...
spectrum_data_files = {'/Nelson_Science_2012/Nelson_Science_data_table_S2.txt', ...
    ...
    '/ExAC/ExAC.chunks001.vcf', ...  % why only first chunk? %  '/ExAC/ExAC.Small.sites.vep.vcf', ...  %    '/ExAC/exome_aggregation.snps_indels.vcf', ... % NEW! exome aggregation data (much richer!!!)
...
switch exome_data
    case 'ExAC'
        exome_struct.spectrum_data_files_str = fullfile(exome_data, 'AllPop', 'ExAC.chunks*_AllPop.mat'); % run on first 100 files  ...
