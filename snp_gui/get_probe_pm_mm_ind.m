%function [pa_vec, ma_vec, pb_vec, mb_vec] =
%get_probe_pm_mm_ind(column_content_cell, quartet_num_vec, match_cell,
%strand_cell)
function [pa_vec, ma_vec, pb_vec, mb_vec] = get_probe_pm_mm_ind(column_content_cell, quartet_num_vec, match_cell, strand_cell)
